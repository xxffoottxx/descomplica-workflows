"""
Francisco Vapi Assistant - Production Template
==============================================

This is the REFERENCE configuration for Francisco, the voice assistant for Mega Loja Borja Reis.

DO NOT deploy changes to production without explicit approval.

Configuration Details:
- Model: gpt-4o (voice-optimized)
- Transcriber: Deepgram Nova-3-general
- Voice: ElevenLabs Turbo v2.5
- Keyterms: ~220 PT-PT hardware store vocabulary (~410-420 tokens)
- Language: European Portuguese (PT-PT) only
...
# Greeting adapts to time of day and business hours
first_message = (
...
payload = {
    ...
    "model": {
        "model": "gpt-4o",  # Voice-optimized (232-320ms latency)
        "messages": [
            {
                "role": "system",
